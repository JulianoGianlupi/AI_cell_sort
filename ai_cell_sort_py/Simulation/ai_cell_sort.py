...
G_vol_ratio_G = 1.0 #constant = 1 for now

G_targetVol_dark_G = G_vol_ratio_G * G_targetVol_light_G # Vtg(D) = eps * Vtg(L)
G_lambdaVol_light_G = 2.0

G_lam_vol_ratio_G = 1 #constant = 1 for now

G_lambdaVol_dark_G = G_lam_vol_ratio_G * G_lambdaVol_light_G#   lmb_v(D) = eps * lmb_v(L) 
